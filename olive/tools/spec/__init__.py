...
def describe_tool():
    return {
        ...
        "allowed_commands": [],
        "examples": [
            '<olive_tool><tool>spec</tool><input>{"command": "create", "title": "Add Builder Mode", "description": "Enable spec-driven execution"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "complete", "spec_id": "20250408_092300"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "cancel", "spec_id": "20250408_092300"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "list"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "get", "spec_id": "20250408_092300"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "get-active"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "set-active", "spec_id": "20250408_092300"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "update", "spec_id": "20250408_092300", "title": "New Title", "priority": "high"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "add-subtask", "spec_id": "20250408_092300", "task": "Inject spec into prompt"}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "complete-subtask", "spec_id": "20250408_092300", "index": 0}</input></olive_tool>',
            '<olive_tool><tool>spec</tool><input>{"command": "add-comment", "spec_id": "20250408_092300", "comment": "Let\'s start with removing git coupling."}</input></olive_tool>',
        ],
    }
